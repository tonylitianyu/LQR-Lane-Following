...
names = {'tStep','tauMax','roadwidth','symEOM','numEOM'};
...
controller.tComputation = toc(tStart);
...
references = struct;
% try
%     r = process.reference(process.t);
%     references = struct('r_des',r);
% catch exception
%     warning(['The ''references'' function that was passed to\n' ...
%              'DesignProblem04 threw the following error:\n\n' ...
%              'threw the following error:\n\n' ...
%              '==========================\n' ...
%              '%s\n', ...
%              '==========================\n\n' ...
%              'Leaving references unchanged.\n'],getReport(exception));
%     references = struct('r_des',inf);
% end
end
